...
# Profane Model Path
PROFANE_MODEL_WEIGHT_PATH = r"weights/profane_model_weight"

# Profane Model Threshold
PROFANE_THRESHOLD = float(0.5)

# Spam Mode Path
SPAM_MODEL_WEIGHT_PATH = r"weights/spam_model_weight"
...
# Default user ID for Post Request
USERID = "12121"

# Default Token for Post request
